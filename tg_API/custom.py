...
from tg_API.base_handler import BaseHandler


class BotCustomDistancePlaces(BaseHandler):
    """Handler returns tourists places with customer settings"""
    ...
    def register_handlers(self):
        ...
        @self.bot.message_handler(func=lambda message: Updated_location.get_command() == 'custom_get_category')
        ...
        @self.bot.message_handler(func=lambda message: Updated_location.get_command() == 'radius_min')
        ...
        @self.bot.message_handler(func=lambda message: Updated_location.get_command() == 'radius_max')
        ...
        @self.bot.message_handler(func=lambda message: Updated_location.get_command() == 'high_set_limit')
        def set_custom_max(message):
            limit = message.text
            if not limit.isdigit():
                ...
                receive_response = self.delete_low_radius(receive_response, int(Updated_location.get_radius_min()))
