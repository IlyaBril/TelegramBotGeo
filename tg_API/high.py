...
class High():
    ...
    @bot.message_handler(func=lambda message: Updated_location.get_command() == 'high_get_category')
    ...
    @bot.message_handler(func=lambda message: Updated_location.get_command() == 'high_get_limit')
